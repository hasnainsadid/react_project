        ...
        <div className="container-fluid py-5">
            <div className="container pt-5 pb-3">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-6 mb-4">
                        <div className="destination-item position-relative overflow-hidden mb-2">
                            <img className="img-fluid" src="assets/img/destination-4.jpg" alt="" />
                            <a className="destination-overlay text-white text-decoration-none" href="">
                    ...
                    <div className="col-lg-4 col-md-6 mb-4">
                        <div className="destination-item position-relative overflow-hidden mb-2">
                            <img className="img-fluid" src="assets/img/destination-5.jpg" alt="" />
                            <a className="destination-overlay text-white text-decoration-none" href="">
                    ...
                    <div className="col-lg-4 col-md-6 mb-4">
                        <div className="destination-item position-relative overflow-hidden mb-2">
                            <img className="img-fluid" src="assets/img/destination-6.jpg" alt="" />
                            <a className="destination-overlay text-white text-decoration-none" href="">
